# CNN_3 consective CNNs with different filter sizes and diff filter no
...
model.fit(padded_train_X, train_y, epochs=75, batch_size=60)
print('here 2')
# evaluate the model
scores = model.evaluate(padded_val_X, val_y)
print("\n%s: %.2f%%" % (model.metrics_names[1], scores[1]*100))
print(datetime.now()- startTime)
#82   filter sizes 5/4/3
#81   filter sizes 1/1/1